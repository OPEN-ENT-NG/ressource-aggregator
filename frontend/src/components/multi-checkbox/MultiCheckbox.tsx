...
interface MutliCheckboxProps {
    checkboxOptions: string[];
    selectedCheckboxes: string[];
    setSelectedCheckboxes: React.Dispatch<React.SetStateAction<string[]>>;
    label: string;
}
export const MutliCheckbox: React.FC<MutliCheckboxProps> = (
    {checkboxOptions, selectedCheckboxes, setSelectedCheckboxes, label}
) => {
    ...
    return (
        <Dropdown>
              <Dropdown.Trigger label={label} badgeContent={selectedCheckboxes.length || 0} />
              <Dropdown.Menu>
                <Dropdown.Item
