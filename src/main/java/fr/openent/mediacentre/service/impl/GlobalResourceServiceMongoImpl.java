    ...
    public Future<JsonObject> createGlobalResource(UserInfos user, JsonObject resource) {
        ...
        this.getMaxIdValue()
            .onSuccess(maxIdValueJson -> {
                Integer maxIdValue = maxIdValueJson.getJsonObject(CURSOR).getJsonArray(CAMEL_FIRST_BATCH).getJsonObject(0).getInteger(CAMEL_MAX_VALUE);
                globalResource.setId(maxIdValue != null ? maxIdValue + 1 : 1);
